...
const Footer = () => {
    return (
        <div className="bg-primary">
            <footer class="footer p-10 bg-primary text-white max-w-7xl mx-auto px-10">
                <div>
            ...
            <footer class="footer px-10 py-4 bg-primary text-white border-base-300 max-w-7xl mx-auto px-10">
