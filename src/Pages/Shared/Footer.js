...
const Footer = () => {
    return (
        <div className="bg-primary">
            <footer className="footer p-10 bg-primary text-white max-w-7xl mx-auto px-10">
                <div>
            ...
            <footer className="footer px-10 py-4 bg-primary text-white border-base-300 max-w-7xl mx-auto px-10">
